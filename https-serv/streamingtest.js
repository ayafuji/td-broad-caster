...
$(document).ready(function() {
  ...
  if (agent.indexOf('safari') > -1) {
    console.log("get capture device...");
    const medias = {
      audio: true
    };
    ...
    function successCallback(stream) {
      console.log("success to get capture device permission....");
      janusInit();
    };
    function errorCallback(err) {
      console.log("failed to get capture device permission....");
    };
  } else {
    janusInit();
  }
      ...
      janus = new Janus(
        {
		  ...
		  // h264
                ...
                onremotestream: function (stream) {
                  Janus.log("==================== trying to start remote stream...");
                  ...
                  if (!addButtons)
                    return;
                  Janus.log("~~~~~~~~~~~~~~~~ : " + Janus.webRTCAdapter.browserDetails.browser);
